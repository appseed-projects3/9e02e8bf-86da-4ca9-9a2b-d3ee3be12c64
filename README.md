...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-20 09:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9e02e8bf-86da-4ca9-9a2b-d3ee3be12c64.git
$ cd 9e02e8bf-86da-4ca9-9a2b-d3ee3be12c64
```
